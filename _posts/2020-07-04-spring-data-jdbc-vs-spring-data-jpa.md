---
title: "Spring Data JPA vs. Spring Data JDBC - When to use Which?"
categories: [spring-boot]
date: 2020-07-02 06:00 +1100
author: prabhakar 
excerpt: "A comprehensive guide for database migrations using Liquibase with Spring Boot.s."
image:
  auto: 0060-data
tags: ["spring-data", "spring-data-jpa", "spring-data-jdbc", ]
---

[Spring Data](https://spring.io/projects/spring-data) is a spring project which provides Spring-based programming model for data access. It makes it easy to access data store whether it is relational or non-relational database by reducing the amount of boilerplate code required to implement data access layers for various persistence stores. [Spring Data JPA](https://spring.io/projects/spring-data-jpa#overview) is a module in Spring Data project which simplifies implemention of JPA based data access layer to relational databases. [Spring Data JDBC](https://spring.io/projects/spring-data-jdbc#overview) is another module in Spring Data project which focuses on simplifying JDBC based
data access layer to relational databases.

The blog gives a quick introduction to the Spring Data project and then gives an overview of Spring Data JPA and Spring Data JDBC with sample projects showing how and on when to use them.
